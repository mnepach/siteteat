      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-[var(--border-color)] transition-transform hover:scale-[1.02] duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="icon-star text-2xl md:text-3xl text-[var(--accent-color)]"></div>
                <h3 className="text-lg md:text-xl font-semibold text-[var(--text-dark)]">
                  Идеальный выбор для вашего сада
                </h3>
              </div>
              <p className="text-[var(--text-dark)] leading-relaxed text-sm md:text-base mb-4">
              ...
              <div className="relative rounded-lg overflow-hidden my-4 shadow-md max-w-2xl mx-auto">
                <img
                ...
                <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 text-white text-sm md:text-base font-medium">
            ...
            <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-[var(--border-color)] transition-transform hover:scale-[1.02] duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="icon-info text-2xl md:text-3xl text-[var(--accent-color)]"></div>
                <h3 className="text-lg md:text-xl font-semibold text-[var(--text-dark)]">
              ...
              <div className="mt-4 bg-[var(--accent-color)] text-white text-sm md:text-base px-4 py-2 md:py-3 rounded-full text-center font-medium shadow-md">
          ...
          <div className="text-center mt-8">
            <a
              href="#order"
              className="btn-primary inline-flex items-center space-x-2 px-6 md:px-8 py-3 md:py-4 rounded-full text-white bg-[var(--primary-color)] hover:bg-[var(--accent-color)] transition-colors duration-300 shadow-lg text-sm md:text-base"
            >
