      ...
      <section id="order" className="px-4 py-12 bg-[var(--secondary-color)] relative" data-name="order-form" data-file="components/OrderForm.js">
        {showError && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 animate-fadeIn">
            <div className="bg-white rounded-3xl p-6 md:p-8 max-w-sm w-full shadow-2xl transform animate-scaleIn">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm md:text-base font-medium text-[var(--text-dark)] mb-2">
                Ваше имя
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 md:py-4 rounded-2xl border border-[var(--border-color)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-color)] focus:border-transparent text-sm md:text-base"
            ...
            <div className="p-4 md:p-6 bg-white rounded-2xl border border-[var(--border-color)]">
              <div className="flex items-center space-x-3 mb-2">
                <div className="icon-info text-[var(--accent-color)]"></div>
                <h4 className="font-medium text-[var(--text-dark)] text-sm md:text-base">Условия доставки</h4>
              </div>
              <ul className="text-sm md:text-base text-[var(--text-light)] space-y-1">
            ...
            <button 
              type="submit" 
              className="btn-primary relative text-sm md:text-base py-3 md:py-4"
              disabled={isSubmitting}
            >
              {isSubmitting ? (
            ...
            <p className="text-xs md:text-sm text-[var(--text-light)] text-center leading-relaxed">
